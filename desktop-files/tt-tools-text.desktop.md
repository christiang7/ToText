...
Icon=video
Terminal=true
Exec=rm ~/.config/tt/log && ttf %f 2>&1 | tee ~/.config/tt/log
...
Exec=rm ~/.config/tt/log && tt-change-format.sh %f 2>&1 | tee ~/.config/tt/log
...
Icon=video
Terminal=true
Exec=rm ~/.config/tt/log && tt-change %f 2>&1 | tee ~/.config/tt/log
...
Icon=video
Terminal=true
Exec=rm ~/.config/tt/log && open-websession.sh %f 2>&1 | tee ~/.config/tt/log
