...
choose=$(zenity --height 350 --list --radiolist --print-column ALL --hide-header --column "Checkbox" --column "What" TRUE Neu FALSE Video FALSE Musik FALSE Spiele FALSE Diverses FALSE Physik FALSE Mathematik FALSE Philosophie FALSE Naturwissenschaften_und_Instrumentarien FALSE CodeFabrik)
if [ ! $? -eq 1 ];
then
...
Spiele) file=$(echo "/home/christian/Gedankenspeicher/Gedankenspeicherwiki/SpielE.txt")
	l=7;;
Diverses) file=$(echo "/home/christian/Gedankenspeicher/Gedankenspeicherwiki/Diverses.txt")
	l=7;;
