...
* ☑ **ttdm**  >  2277-11-11
  ...
  ``noweb.py -Rttdm ttdm.txt > ttdm && chmod u+x ttdm && ln -sf /home/christian/Gedankenspeicher/Gedankenspeicherwiki/Zettelkasten/Gedankenwanderung/Programme/ttdm ~/.local/bin/ttdm && echo 'fertig``'
